package com.et.activity.common.db;
...
import com.et.activity.common.util.L;
...
//			break;
	...
	public static final class CityConstants implements BaseColumns {
		...
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/cissty";
		...
		public static final String POST_ID = "postID";//临时城市列表的城市id  用于请求城市的天气
		...
		public static final String ISLOCATION = "isLocation"; //临时城市列表 是否是定位 手动选择的城市存储为0 自动定位为1
