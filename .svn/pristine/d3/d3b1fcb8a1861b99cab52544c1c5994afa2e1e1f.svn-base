...
import com.et.beans.City;
import com.et.common.db.CityProvider;
import com.et.common.db.CityProvider.CityConstants;
...
public class SystemUtils {
	...
	public static void copyDB(Context context) {
		...
		// 如果不是第一次运行程序，直接返回
		if (!SPTool.getBoolean("isFirstRun", true))
			return;
		...
		try {
			...
			SPTool.saveBoolean("isFirstRun", false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
